...
$plugins->add_hook('global_start', 'mphpbb16_update_style');
$plugins->add_hook('global_end', 'mphpbb16_update_global');
$plugins->add_hook('index_end', 'mphpbb16_update_index');
$plugins->add_hook('member_do_login_end', 'mphpbb16_update_login');
$plugins->add_hook('postbit', 'mphpbb16_update_postbit');
$plugins->add_hook('pre_output_page', 'mphpbb16_update_output_page');
$plugins->add_hook('redirect', 'mphpbb16_update_redirect');
$plugins->add_hook('showthread_end', 'mphpbb16_update_showthread');
...
function mphpbb16_update_style()
{
...
function mphpbb16_update_global()
{
	if ( !defined('MMYBB16') )
	{
		return;
...
function mphpbb16_update_index()
{
	if ( !defined('MMYBB16') )
	{
		return;
	...
	global $mybb, $lang, $templates;
	global $footer_personal, $forums, $header_option, $index_panel, $welcomeblock;
...
function mphpbb16_update_login()
{
	if ( !defined('MMYBB16') )
	{
		return;
...
function mphpbb16_update_postbit($post)
{
	if ( !defined('MMYBB16') )
	{
		return;
...
function mphpbb16_update_output_page($contents)
{
	if ( !defined('MMYBB16') )
	{
		return;
...
function mphpbb16_update_redirect($redirect_args)
{
	if ( !defined('MMYBB16') )
	{
		return;
...
function mphpbb16_update_showthread()
{
	if ( !defined('MMYBB16') )
	{
		return;
